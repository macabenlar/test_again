              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Name: $firstName $lastName', style: TextStyle(fontSize: 20), textAlign: TextAlign.center),
                    const SizedBox(height: 10),
                    Text('Gender: $gender', style: TextStyle(fontSize: 18), textAlign: TextAlign.center),
                    const SizedBox(height: 10),
                    Text('Grade: $grade', style: TextStyle(fontSize: 18), textAlign: TextAlign.center),
                  ],
                ),
              ),
            ),
